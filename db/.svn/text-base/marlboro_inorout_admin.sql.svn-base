...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 07, 2014 at 06:18 AM
...
--
-- Dumping data for table `admin_pages_modules`
--

INSERT INTO `admin_pages_modules` (`id`, `module`, `classcall`, `n_status`) VALUES
(1, 'LIst User', 'listuser', 1),
(2, 'notification', '', 1),
(3, 'module barus', 'barus', 1);
...
--
-- Dumping data for table `admin_pages_permission`
--

INSERT INTO `admin_pages_permission` (`id`, `pagetype`, `moduleid`, `acts`, `datetimes`, `n_status`) VALUES
(1, 0, 1, '', '2014-01-28 17:35:33', 1),
(3, 0, 2, 'apa ajah', '2014-01-28 17:40:01', 1),
(5, 0, 3, '', '2014-01-28 17:41:04', 1),
(10, 3, 1, '', '2014-01-28 17:42:06', 1),
(11, 3, 3, '', '2014-01-28 17:42:14', 1),
(12, 5, 1, '', '2014-01-28 17:42:28', 1),
(13, 5, 2, 'apa ajah', '2014-01-28 17:42:30', 1);
...
INSERT INTO `admin_roles` (`id`, `userid`, `name`, `description`, `type`, `img`, `created_date`, `closed_date`, `n_status`) VALUES
(1, 218, 'admin', '', 2, '', '2014-01-28 14:54:27', '2019-01-28 14:54:27', 1);
...
(3, 'gembala', 'ngebajak sawah', 1),
(4, 'kapten', 'kapten bajak laut', 1),
(5, 'koki', 'tukang masak', 1),
(6, 'role baru', 'baru ajah', 1);
...
(217, '', 'bummi', 'bummi', 'bummi@kana.co,id', '2013-11-29 16:59:01', NULL, NULL, 'bummi@kana.co.id', '2014-02-05 14:00:03', 123, 'YES', '2013-11-21', NULL, 'dwi', 1, 17, 0, 0, 1, '12345678', '2f7aa0afe8a34a70804bc6a83c5ddc626e8fd3ac'),
(218, '', 'akuh', 'akuh', 'asdqwe@asdqwe.com', '2014-01-28 07:54:27', NULL, NULL, 'asdqwe', '2014-01-28 15:38:06', NULL, 'Male', NULL, NULL, 'anak gembala ', 1, 1, 0, 0, 0, '12345678', '5e614e41ef39257801d2cfece59fdd3dcf1fd75c');
