<?php /* Smarty version 2.6.13, created on 2014-02-13 16:49:34
         compiled from application/admin/apps/event-pages.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'application/admin/apps/event-pages.html', 62, false),)), $this); ?>
<div id="theContainer" class="inboxPage">
    <div class="theContainer">
        <div class="head-title">
            <h1 class="fl">Event Pages</h1>
        </div> <!-- /.head-title -->
        <div class="short2">
            <form method="POST" action="<?php echo $this->_tpl_vars['basedomain']; ?>
event" id="shorter" class="formsubmitmanualmoderation" >
...
&nbsp;</td>
						...
						<td><?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['headline']; ?>
</td>
						<td><?php if ($this->_tpl_vars['list'][$this->_sections['i']['index']]['type'] == 1): ?>Event<?php else: ?>Clue<?php endif; ?></td>
						<td><img height="70px" width="70px" src="<?php echo $this->_tpl_vars['basedomainpath']; ?>
public_assets/event/<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['img']; ?>
"></td>
...
gallery/seegallery?id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['id']; ?>
" class="red" >Gallery</a>
							|
							<a href="<?php echo $this->_tpl_vars['basedomain']; ?>
event/saveData?id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['id']; ?>
" class="red" >update</a>
							| <a href="<?php echo $this->_tpl_vars['basedomain']; ?>
event/hapus?id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['id']; ?>
" class="red" onclick="return confirm('Are you sure you want to delete this?')">delete</a>
			...
			<a href="<?php echo $this->_tpl_vars['basedomain']; ?>
event/newDataInput" class="fr addNewContent">add new</a>
			</table>
             <div class="pagingbox">
