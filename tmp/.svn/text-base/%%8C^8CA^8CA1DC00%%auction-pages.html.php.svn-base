<?php /* Smarty version 2.6.13, created on 2014-02-13 15:18:14
         compiled from application/admin/apps/auction-pages.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'application/admin/apps/auction-pages.html', 60, false),)), $this); ?>
...
auction" id="shorter" class="formsubmitmanualmoderation" >
...
public_assets/auctions/<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['img']; ?>
" ></td>
...
auction/auctionedit?id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['id']; ?>
" class="red">Update</a>
							| <a href="<?php echo $this->_tpl_vars['basedomain']; ?>
auction/hapus?id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['id']; ?>
" class="red" onclick="return confirm('Are you sure you want to delete this?')">delete</a>
			...
			<a href="<?php echo $this->_tpl_vars['basedomain']; ?>
auction/newDataInput" class="fr addNewContent">add new</a>
			</table>
             <div class="pagingbox">
