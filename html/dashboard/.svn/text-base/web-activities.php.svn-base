	...
	<ul class="columns-content page-content clearfix">
    	<div id="tabs">
    		...
    		<ul class="nav">
                ...
                <li class="nav-five"><a href="#mostViewed" id="most">Most Viewed Artists</a></li>
                <li class="nav-six"><a href="#badgesPoints" id="most">Badges & Points</a></li>
                <li class="nav-seven last"><a href="#redeemMerchandise" id="most">Redeem Merchandise</a></li>
            </ul>
    		<div class="list-wrap">
    			<ul id="userActivities">
                 ...
                 <ul id="badgesPoints" class="hide">
                   	<?php include('widget/badgesPoints.php'); ?>
        		 </ul>
                 <ul id="redeemMerchandise" class="hide">
                   	<?php include('widget/redeemMerchandise.php'); ?>
        		 </ul>
