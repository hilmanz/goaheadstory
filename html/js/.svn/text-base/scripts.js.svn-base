$(document).ready(function() { 
	...
	$(".toggle .title").toggle(function(){
		$(this).addClass("active").closest('.toggle').find('.inner').slideDown(200, 'easeOutCirc').css( "z-index","30" );
	}, function () {
		$(this).removeClass("active").closest('.toggle').find('.inner').slideUp(200, 'easeOutCirc').css( "z-index","30" );
	});
	jQuery("#right_menu .inner").mouseleave(function(){		
		$(".toggle,.toggle .title").removeClass("active").closest('.toggle').find('.inner').slideUp(200, 'easeOutCirc').css( "z-index","30" );
	});
