...
class home extends App{
	...
	function main(){
		...
		$loginData = $this->dataHelper->loginUser();
		$activeUser = $this->dataHelper->loginUser('active');
		$superUser = $this->dataHelper->loginUser('weekly');
		$veryActive = $this->dataHelper->loginUser('monthly');
		// pr($veryActive);
